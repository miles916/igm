...
%%%%%%%% Paths %%%%%%%
root='C:\Users\miles\Documents\GitHub\igm\examples\ESM-rongbuk-invert';
addpath(genpath(['C:\Users\miles\Dropbox\Matlab_RS_analyses\topotoolbox-2.3-2-gd37394e']));
addpath(genpath([root '\TC_setups\Functions\topotoolbox'])) % Topotoolbox


SITE = 'Rongbuk'; % Catchment name
simnm = 'IGM_test';
...
pyenv('Version', ... 
            'C:\Users\miles\AppData\Local\Continuum\anaconda3\envs\igm\python.exe', ... 
...
igm_run_path = ['C:\Users\miles\Documents\GitHub\igm\examples\ESM-rongbuk-invert\igm-run.py']; % path of IGM .py script
